...
outdir = os.path.join(workdir, "06classification_20231115", "feature_importance_boxplots_KOs")
...
kegg_kos['KO_short_name'] = kegg_kos['KO_name'].str.split(";", expand=True)[1].str.split("[", n=1, expand=True)[0].str.strip()
kegg_kos['KO_desc'] = kegg_kos.index.values + ": " + kegg_kos['KO_short_name']
...
for study in studies:
    for stage in stages:
        ...
        for model in models:
            ...
            infile = os.path.join(workdir, "06classification_20231115", '{}_{}'.format(study, taxon),
            ...
            if os.path.exists(infile):
                ...
                #print(data['median'])
                data = pd.merge(data, kegg_kos, left_index=True, right_index=True, how="left")
                ...
                data_melt = pd.melt(data_sort, id_vars=['features', 'KO_desc', 'Significance', 'median'],
