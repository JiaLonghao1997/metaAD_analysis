...
inputdir = "/home1/jialh/brain/01meta/multikingdom/06classification_20231115/feature_importance_boxplots"
...
for (stage in stages){
    ...
    print(table(data$Pathway_category2))
    ###氨基酸代谢。
...
merge_img = ggarrange(plotlist=imglist, nrow=2, ncol=2, align="hv", labels=letters[5:8])
