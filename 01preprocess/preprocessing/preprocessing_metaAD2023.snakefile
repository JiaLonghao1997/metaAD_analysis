...
rule trim_galore:
    ...
    shell: """
        ...
        zcat -f {params.orp_fwd} {params.orp_rev} | /home1/jialh/anaconda3/envs/cutadapt/bin/pigz -b 32 -p {threads} > {output.orp}
...
rule readcounts:
    ...
    resources:
        time = 24
    shell:"""
    echo "python scripts/read_counts.py {DATA_DIR} {PROJECT_DIR} {SAMPLE_PREFIX} {output} {READ_SUFFIX} {EXTENSION} {gz_ext}";
    python scripts/read_counts.py {DATA_DIR} {PROJECT_DIR} {SAMPLE_PREFIX} {output} {READ_SUFFIX} {EXTENSION} {gz_ext}
    """
